class ItcSlider {
  ...
  static CLASS_ITEM_ACTIVE = '.slider__item';
  static CLASS_INDICATOR_ACTIVE = '';
  ...
  constructor(selector, config) {
    ...
    this._delay = Math.round(parseFloat(styleElItems.transitionDuration) * 1);
